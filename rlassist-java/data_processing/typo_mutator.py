...
class Typo_Mutate_Java(Typo_Mutate):
    __action_pattern_map = {
           'delete(' : ("LPAREN", ""),
           'delete)' : ("RPAREN", ""),
           'delete,' : ("COMMA", ""),
           ...
           'delete{' : ("LBRACE", ""),
           'delete}' : ("RBRACE", ""),
           'duplicate(' : ("LPAREN", "LPAREN LPAREN"),
           'duplicate)' : ("RPAREN", "RPAREN RPAREN"),
           'duplicate,' : ("COMMA", "COMMA COMMA"),
           'duplicate{' : ("LBRACE", "LBRACE LBRACE"),
           'duplicate}' : ("RBRACE", "RBRACE RBRACE"),           
           'replace;with,' : ("SEMI", "COMMA"),
           'replace,with;' : ("COMMA", "SEMI"),
           'replace;with.' : ("SEMI", "DOT"),
           'replace);with;)' : ("RPAREN SEMI", "SEMI RPAREN"),
          }
